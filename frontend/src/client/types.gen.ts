...
export type AssetInstrumentCreate = {
    asset_type: string;
    symbol: string;
    display_name: string;
...
export type AssetInstrumentPublic = {
    asset_type: string;
    symbol: string;
    display_name: string;
    canonical_name?: (string | null);
...
export type AssetInstrumentsPublic = {
    data: Array<AssetInstrumentPublic>;
    count: number;
};

export type AssetInstrumentUpdate = {
...
export type AssetsReadAssetsResponse = (AssetInstrumentsPublic);

export type AssetsCreateAssetData = {
    requestBody: AssetInstrumentCreate;
};

export type AssetsCreateAssetResponse = (AssetInstrumentPublic);

export type AssetsReadAssetData = {
    assetId: string;
};

export type AssetsReadAssetResponse = (AssetInstrumentPublic);
...
export type AssetsUpdateAssetResponse = (AssetInstrumentPublic);
